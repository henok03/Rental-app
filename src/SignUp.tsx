    ...
    try {
      ...
      if (data.user) {
        const { error: profileError } = await supabase
          .from("profiles")
          .insert({ id: data.user.id, full_name: fullName, email: data.user.email });
...
setTimeout(() => {
  ...
  return (
    <div style={{
      ...
      {/* Background glows */}
      <div style={{ position: "fixed", top: "-100px", right: "-80px", width: "500px", height: "500px", background: "radial-gradient(ellipse, rgba(124,58,237,0.12) 0%, transparent 70%)", pointerEvents: "none", zIndex: 0 }} />
      <div style={{ position: "fixed", bottom: "-80px", left: "-60px", width: "400px", height: "400px", background: "radial-gradient(ellipse, rgba(56,132,255,0.08) 0%, transparent 70%)", pointerEvents: "none", zIndex: 0 }} />
        ...
        <div style={{ width: "100%", maxWidth: "420px" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              {successMsg && (
                <div style={{ display: "flex", alignItems: "center", gap: "8px", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: "10px", padding: "11px 14px", fontSize: "13px", color: T.success }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={T.success} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                  {successMsg}
                </div>
              )}
